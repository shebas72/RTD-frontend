  ...
  const operationsSlides: SlideItem[] = [
    {
      ...
      subtitle: 'Never outsourced to third-party ad-hoc freelancers. Uniformed drivers, GPS tracking on all delivery cargo, and guaranteed delivery SLAs.',
    ...
    },
    {
      ...
      subtitle: 'Navigating Achrafieh, Hamra, and Verdun in peak traffic hours. Rapid 2-4 hour point-to-point and same-day apparel exchange logistics.',
