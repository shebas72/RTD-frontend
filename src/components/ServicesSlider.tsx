...
export const ServicesSlider: React.FC<ServicesSliderProps> = ({
  ...
  const services: ServiceSlide[] = [
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1589710751893-f9a6770ad71b?auto=format&fit=crop&w=1600&q=80',
    ...
    },
    {
      ...
      fallbackImage: 'https://images.unsplash.com/photo-1519003722824-194d4455a60c?auto=format&fit=crop&w=1600&q=80',
      icon: Truck,
      highlights: [
